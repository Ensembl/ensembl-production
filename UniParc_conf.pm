...
Bio::EnsEMBL::EGPipeline::PipeConfig::UniParc_conf
...
sub default_options {
  ...
  return {
	...
	pipeline_name => 'uniparc_' . $self->o('ensembl_release'),
...
sub pipeline_analyses {
  ...
  return [
	...
	{-logic_name => 'LoadUniParc',
	 ...
	 -parameters => {
				   uniparc_user   => 'ensro',
				   uniparc_host   => 'mysql-eg-pan-1.ebi.ac.uk',
				   uniparc_port   => 4276,
				   uniparc_dbname => 'uniparc'},
	 -max_retry_count => 3,
	 -hive_capacity   => 10,
	 -rc_name         => 'normal',}
