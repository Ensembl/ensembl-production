...
=head1 NAME
 ...
 Bio::EnsEMBL::EGPipeline::PostCompara::PipeConfig::PairAlignerStats_conf
...
=head1 SYNOPSIS
    ...
    #4. Run init_pipeline.pl script:
        ...
        init_pipeline.pl Bio::EnsEMBL::EGPipeline::PostCompara::PipeConfig::PairAlignerStats_conf --dbname hsap_ggor_lastz_64 --password <your_password) --mlss_id 536 --dump_dir /lustre/scratch103/ensembl/kb3/scratch/hive/release_64/hsap_ggor_nib_files/ --pair_aligner_options "T=1 K=5000 L=5000 H=3000 M=10 O=400 E=30 Q=/nfs/users/nfs_k/kb3/work/hive/data/primate.matrix --ambiguous=iupac" --bed_dir /nfs/ensembl/compara/dumps/bed/
