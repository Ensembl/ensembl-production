...
package Bio::EnsEMBL::Production::Pipeline::Search::ReformatProbesAdvancedSearch;
...
sub run {
  ...
  my $probes_file = $self->param('dump_file');
  ...
  $reformatter->remodel_probes($probes_file, $genome_file,
      $probes_file_out
  );
  return;
} ## end sub run
