...
Bio::EnsEMBL::Production::Pipeline::Common::DatabaseDumper

=head1 DESCRIPTION

This is a simple wrapper around the Hive module; all it's really doing
is creating an appropriate dbconn for that modules
...
package Bio::EnsEMBL::Production::Pipeline::Common::DatabaseDumper;
