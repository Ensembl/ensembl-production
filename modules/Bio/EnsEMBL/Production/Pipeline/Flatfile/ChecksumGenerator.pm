...
package Bio::EnsEMBL::Production::Pipeline::Flatfile::ChecksumGenerator;

use strict;
use warnings;

use base qw/Bio::EnsEMBL::Production::Pipeline::ChecksumGenerator Bio::EnsEMBL::Production::Pipeline::Flatfile::Base/;
