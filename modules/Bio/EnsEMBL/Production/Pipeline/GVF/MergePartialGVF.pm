...
=head1 NAME
 ...
 Bio::EnsEMBL::Production::Pipeline::GVF::MergePartialGVF;
...
=cut
package Bio::EnsEMBL::Production::Pipeline::GVF::MergePartialGVF;
...
sub run {
    ...
    my $temp_dir         = $self->param('temp_gvf_file_dir');
    ...
    $logger->info("gvf_file_hash=\n" . Dumper($gvf_file_hash)) if($self->debug);
