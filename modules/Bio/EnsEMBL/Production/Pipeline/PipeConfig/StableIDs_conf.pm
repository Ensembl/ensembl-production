...
sub pipeline_analyses {
    ...
    {     -logic_name      => "stable_id_non_vert",
          ...
          -parameters  => {
           'cmd' =>
            'perl #base_dir#/ensembl/misc-scripts/stable_id_lookup/populate_stable_id_lookup.pl $(#db_srv# details script_l) $(#species_server# details script) -version #release#',
