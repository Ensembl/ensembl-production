...
package Bio::EnsEMBL::Production::Pipeline::PipeConfig::ProteinFeaturesMVP_ResourceDownload_conf;
...
sub pipeline_analyses {
    ...
    return [
...

        {
            ...
            -flow_into       => [ 'FetchInterPro', 'FetchInterPro2GO', 'FetchUniParc' ],
            -rc_name           => '4GB_D',
        },
...

        {
            ...
            -flow_into       =>  [ 'FetchUniProt', 'LoadUniParc' ],
            -rc_name         => 'dm',
        },
