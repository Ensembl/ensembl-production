...
=cut
package Bio::EnsEMBL::Production::Pipeline::PipeConfig::InterProScanSeed_conf; 
...
sub pipeline_analyses {
  ...
  return [
    ...
    { -logic_name      => 'job_factory',
      ...
      -rc_name         => 'default',
      -flow_into       => { 
                            # Need semaphore here, so that if subsequent job seeding, the 
                            # 'cleanup_prot_feat' will NOT start before I5 scan all completed                          
