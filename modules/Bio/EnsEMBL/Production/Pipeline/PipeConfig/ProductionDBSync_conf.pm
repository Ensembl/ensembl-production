  ...
  return [
    ...
    },
    {
      ...
      -parameters        => {
                              ...
                              output_file     => catdir($self->o('datacheck_output_dir'), 'ControlledTables.txt'),
                              failures_fatal  => 1,
                            },
      -rc_name           => 'normal',
    },
    {
      ...
      -parameters        => {
                              ...
                              registry_file    => $self->o('registry'),
                              history_file     => $self->o('history_file'),
                              output_file      => catdir($self->o('datacheck_output_dir'), 'ADCritical.txt'),
                              failures_fatal   => 1,
                            },
      -rc_name           => 'normal',
    },
    {
      ...
      -parameters        => {
                              ...
                              registry_file    => $self->o('registry'),
                              history_file     => $self->o('history_file'),
                              output_file      => catdir($self->o('datacheck_output_dir'), 'ADAdvisory.txt'),
                              failures_fatal   => 0,
                            },
      -rc_name           => 'normal',
      -flow_into         => {
