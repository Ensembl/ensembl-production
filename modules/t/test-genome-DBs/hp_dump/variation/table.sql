...
) ENGINE=MyISAM AUTO_INCREMENT=615872868 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=102178 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=17890 DEFAULT CHARSET=latin1;
...
CREATE TABLE `population_genotype` (
  ...
  KEY `variation_idx` (`variation_id`),
  KEY `subsnp_idx` (`subsnp_id`)
) ENGINE=MyISAM AUTO_INCREMENT=135861382 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=19000001 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=63008 DEFAULT CHARSET=latin1;
...
CREATE TABLE `variation` (
  ...
  KEY `source_idx` (`source_id`)
) ENGINE=MyISAM AUTO_INCREMENT=112643606 DEFAULT CHARSET=latin1;
...
CREATE TABLE `variation_feature` (
  ...
  KEY `consequence_type_idx` (`consequence_types`),
  KEY `source_idx` (`source_id`)
) ENGINE=MyISAM AUTO_INCREMENT=111656945 DEFAULT CHARSET=latin1;
