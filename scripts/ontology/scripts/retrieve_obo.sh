...
wget "http://www.geneontology.org/ontology/obo_format_1_2/gene_ontology.1_2.obo" -O GO.obo
wget "https://raw.githubusercontent.com/The-Sequence-Ontology/SO-Ontologies/master/so-xp-simple.obo" -O SO.obo
wget "http://palea.cgrb.oregonstate.edu/viewsvn/Poc/trunk/ontology/OBO_format/plant_ontology.obo?view=co" -O PO.obo
wget "http://palea.cgrb.oregonstate.edu/viewsvn/Poc/trunk/ontology/collaborators_ontology/gramene/temporal_gramene.obo?view=co" -O GRO.obo
wget "http://palea.cgrb.oregonstate.edu/viewsvn/Poc/trunk/ontology/collaborators_ontology/gramene/taxonomy/GR_tax-ontology.obo?view=co" -O GR_TAX.obo
wget "http://obo.cvs.sourceforge.net/viewvc/obo/obo/ontology/phenotype/environment/environment_ontology.obo?view=co" -O EO.obo
wget "http://palea.cgrb.oregonstate.edu/viewsvn/Poc/trunk/ontology/collaborators_ontology/gramene/traits/trait.obo?view=co" -O TO.obo
...
wget "http://purl.obolibrary.org/obo/cl-basic.obo" -O CL.obo
wget "https://raw.githubusercontent.com/pato-ontology/pato/master/pato.obo" -O PATO.obo
