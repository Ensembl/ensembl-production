...
for db_type in otherfeatures cdna rnaseq; do
    ...
    for db in $(grep $db_type $file); do 
        ...
        ./sync_tables.sh $srv $core $db assembly assembly_exception coord_system meta seq_region seq_region_synonym seq_region_attrib karyotype mapping_set seq_region_mapping
    done
done
rm -f $file