...
sub Usage {
 ...
 $0 --host <host name> --dbname_ref <DB name> [--dblist <DB name>] [--write] [--dbhost_ref <host name>] [--dbport_ref <port number>] [--port <int>] [--user <user name>] [--pass <passwd>] [--log_file <path to file>] [--parallel]
        ...
        Optionnal
            ...
            --dbhost_ref Host of the human database, default ens-livemirror
            --dbport_ref Port number of the human database, default 3306
            --log_file   Name of the log file, all human protein name with their linked element
                          would be written here
            --port       Port number, default 3306
            --user       User name, must be an admin, default ensadmin
