...
Update mapping_set information for all databases in mysql-ens-sta-1 in
...
my $host           = 'mysql-ens-sta-1';
my $oldhost        = 'mysql-ensembl-mirror';
my $dbname         = undef;
my $user           = undef;
my $pass           = undef;
my $port           = 4519;
