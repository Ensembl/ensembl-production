...
export PERL5LIB=$PWD/bioperl-live-bioperl-release-1-2-3:$PWD/ensembl-test/modules:$PWD/ensembl/modules:$PWD/ensembl-compara/modules:$PWD/ensembl-metadata/modules:$PWD/ensembl-datacheck/lib:$PWD/ensembl-variation/modules:$PWD/ensembl-hive/modules:$PWD/ensembl-orm/modules:$PWD/modules:$PWD/ensembl-taxonomy/modules:$PWD/modules
