...
Bio::EnsEMBL::EGPipeline::PipeConfig::UniProt_conf
...
package Bio::EnsEMBL::EGPipeline::PipeConfig::UniProt_conf;
...
sub default_options {
  ...
  return {
	...
	pipeline_name => 'uniprot_' . $self->o('ensembl_release'),
  ...
  return [
	...
	{-logic_name => 'LoadUniProt',
	 ...
	 -parameters => {
				   ...
				   uniparc_user   => 'uniparc_read',
				   uniparc_pass   => 'uniparc',
				   uniparc_host   => 'ora-vm-004.ebi.ac.uk',
				   uniparc_port   => 1551,
				   uniparc_dbname => 'UAPRO',
				   uniparc_driver => 'Oracle', 
	 },
	 -max_retry_count => 3,
	 -hive_capacity   => 10,
	 -rc_name         => 'normal',}
