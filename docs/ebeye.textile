...
bc. 
    ...
    $ export ENSADMIN_PSW=wibble
    $ export LOG_DIR=${ENSEMBL_CVS_ROOT_DIR}/ensembl-personal/${USER}/pipelines/${RELEASE}/ebeye
    $ export DUMPS_DIR=/lustre/scratch109/ensembl/${USER}/${RELEASE}
    $ export PATH=$ENSEMBL_CVS_ROOT_DIR/ensembl-hive/scripts:/path/to/xml:$PATH
