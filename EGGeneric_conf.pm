...
sub resource_classes {
  ...
  return {
    ...
    '4Gb_mem'           => {'LSF' => '-q production-rh7 -M  4000 -R "rusage[mem=4000]"'},
    '8Gb_mem'           => {'LSF' => '-q production-rh7 -M  8000 -R "rusage[mem=8000]"'},
    '12Gb_mem'          => {'LSF' => '-q production-rh7 -M 12000 -R "rusage[mem=12000]"'},
    '16Gb_mem'          => {'LSF' => '-q production-rh7 -M 16000 -R "rusage[mem=16000]"'},
    '24Gb_mem'          => {'LSF' => '-q production-rh7 -M 24000 -R "rusage[mem=24000]"'},
    '32Gb_mem'          => {'LSF' => '-q production-rh7 -M 32000 -R "rusage[mem=32000]"'},
    '2Gb_mem_4Gb_tmp'   => {'LSF' => '-q production-rh7 -M  2000 -R "rusage[mem=2000,tmp=4000]"'},
    ...
    '12Gb_mem_4Gb_tmp'  => {'LSF' => '-q production-rh7 -M 12000 -R "rusage[mem=12000,tmp=4000]"'},
    ...
    '24Gb_mem_4Gb_tmp'  => {'LSF' => '-q production-rh7 -M 24000 -R "rusage[mem=24000,tmp=4000]"'},
    '32Gb_mem_4Gb_tmp'  => {'LSF' => '-q production-rh7 -M 32000 -R "rusage[mem=32000,tmp=4000]"'},
  }
}
